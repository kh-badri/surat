...
<div class="bg-white p-6 rounded-lg shadow-md">
    <form action="<?= site_url('guru/store') ?>" method="post">
        ...
        <div class="mb-4">
            ...
            <select name="kecamatan_id" id="kecamatan_id" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">
                ...
                <?php foreach ($wilayah as $w) : ?>
                    <option value="<?= $w['id'] ?>" <?= old('kecamatan_id') == $w['id'] ? 'selected' : '' ?>><?= $w['kecamatan'] ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="tahun" id="tahun" value="<?= old('tahun', date('Y')) ?>" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="jumlah" id="jumlah" value="<?= old('jumlah') ?>" class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2">
        ...
        <div class="mt-6">
            <button type="submit" class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">Simpan</button>
        </div>
    </form>
</div>

...
<script>
    // Menyesuaikan field 'oldData' untuk menangkap semua input
    const oldData = {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createMahasiswaFields(data = {}) {
            ...
            // Field dasar yang selalu ada (NPM & Nama)
            let fields = `
            <div>
            ...
            // Menambahkan field spesifik berdasarkan template yang dipilih
            switch (template) {
                ...
                case 'pengantar_kp':
                    fields += `
                        ...
                        <div>
                            ...
                            <input type="text" name="waktu_pelaksanaan[]" class="w-full px-3 py-2 border border-gray-300 rounded-md" value="${data.waktu_pelaksanaan || ''}" placeholder="Contoh: Juli - Agustus 2025">
                        </div>`;
                    break;
                    // ====================================================== //
        ...
        // Memuat ulang data jika ada kesalahan validasi
        if (oldData.npm && oldData.npm.length > 0) {
            ...
            // Jika halaman baru, tambahkan satu set field kosong

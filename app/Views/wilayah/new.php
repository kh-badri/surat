...
<form action="<?= site_url('wilayah') ?>" method="post" class="bg-white p-6 rounded shadow-md w-full max-w-lg">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="kecamatan" id="kecamatan" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    </div>

...
<div class="container mx-auto p-4">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Tambah Data Selisih</h1>

    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="<?= site_url('selisih/create') ?>" method="post">
            <?= csrf_field(); ?>
            ...
            <div class="mb-4">
                ...
                <select name="kecamatan_id" id="kecamatan_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline <?= (session('errors.kecamatan_id')) ? 'border-red-500' : ''; ?>" required>
                    ...
                    <?php foreach ($kecamatans as $kecamatan) : ?>
                        <option value="<?= $kecamatan['id_prediksi']; ?>" <?= (old('kecamatan_id') == $kecamatan['id_prediksi']) ? 'selected' : ''; ?>><?= $kecamatan['kecamatan']; ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="hasil_prediksi_id" id="hasil_prediksi_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight focus:outline-none focus:shadow-outline" readonly value="<?= old('hasil_prediksi_id'); ?>">
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="jumlah_guru_id" id="jumlah_guru_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline <?= (session('errors.jumlah_guru_id')) ? 'border-red-500' : ''; ?>" required>
                    ...
                    <?php foreach ($jumlah_gurus as $guru) : ?>
                        <option value="<?= $guru['id_guru']; ?>" <?= (old('jumlah_guru_id') == $guru['id_guru']) ? 'selected' : ''; ?>><?= $guru['jumlah']; ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="kebutuhan" id="kebutuhan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight focus:outline-none focus:shadow-outline" readonly value="<?= old('kebutuhan'); ?>">
            </div>

            <div class="mb-4">
                <label for="nilai_selisih" class="block text-gray-700 text-sm font-bold mb-2">Nilai Selisih</label>
                <input type="number" step="0.01" name="nilai_selisih" id="nilai_selisih" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight focus:outline-none focus:shadow-outline" readonly value="<?= old('nilai_selisih'); ?>">
            </div>

            <div class="mb-4">
                <label for="keterangan" class="block text-gray-700 text-sm font-bold mb-2">Keterangan</label>
                <input type="text" name="keterangan" id="keterangan" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 bg-gray-100 leading-tight focus:outline-none focus:shadow-outline" readonly value="<?= old('keterangan'); ?>">
            </div>

...
<head>
    <meta charset="UTF-8">
    <title>Surat Usulan SK Sidang Meja Hijau</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="kop-surat">
            <?php
            // Pastikan path ke logo benar, misalnya di dalam folder public
        ...
        <div class="footer-text" style="margin-top: 30px;">
            <p>Dengan hormat,</p>
            <p style="text-align: justify;">Sehubungan dengan Permohonan Ujian Sidang Meja Hijau Mahasiswa yang ditujukan Kepada Ketua Program Studi Teknik Informatika.</p>
            <p style="text-align: justify;">Setelah dievaluasi, telah memenuhi persyaratan yang telah ditetapkan oleh Program Studi Teknik Informatika untuk dapat diusulkan Dosen Penguji Skripsi (Sidang Meja Hijau).</p>
            <p style="text-align: justify;">Berkenaan dengan hal tersebut diatas, diusulkan kepada Bapak/Ibu Dosen Penguji Sidang Meja Hijau untuk ditetapkan dalam Surat Keputusan (Terlampir).</p>
        ...
        <h4 style="text-align: center; text-transform: uppercase; margin-top: 30px;">Daftar Nama Mahasiswa dan Dosen Penguji Sidang Meja Hijau</h4>
        ...
        <table class="lampiran-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 18%;">Dosen Penguji I/II</th>
                ...
                <?php if (!empty($mahasiswa) && is_array($mahasiswa)) : ?>
                    <?php foreach ($mahasiswa as $mhs) : ?>
                        <tr>
                            ...
                            <td><?= nl2br(esc($mhs['dosen_penguji'] ?? '')); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
